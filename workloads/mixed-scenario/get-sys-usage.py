...
def get_ovn_metrics(metricName, start_time, end_time, promQLOperation):
        ...
        if promQLOperation == "topMaxOverTime":
            ...
            promQL = "{}".format(metricName, timeDuration)
        else:
            print("Unsupported prom QL operations, support type is: topMaxOverTime,topAvgOverTime,topMaxOverTimeSumByPod,topAvgOverTimeSumByPod,topMaxOverTimeSumByNode")
            exit(1)
        print("-" * 120)
        print(promQL)
        print("-" * 120)
