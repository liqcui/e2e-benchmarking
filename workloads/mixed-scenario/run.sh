...
EOF
        ...
        #Creating pod-reader cluster-role and cluter-role-binding
        oc  apply -f-<<EOF
...
EOF
        ...
        waiting_for_during_each_phase "Final Phase:" 300 "after rollback cluster-version-operator and network-operator" true
